...
public class RealizarTransferenciaView extends JPanel {
    ...
    public RealizarTransferenciaView(ServicioBancario servicio) {
        this.servicio = servicio;
        RealizarTransferenciaController realizarTransferenciaController = new RealizarTransferenciaController(servicio);
        ...
        transferirBtn.addActionListener(e -> {
            try {
                ...
                boolean exito = realizarTransferenciaController.transferir(origen.getId(), destino.getId(), monto);
