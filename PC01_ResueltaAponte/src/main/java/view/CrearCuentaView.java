...
public class CrearCuentaView extends JPanel {
    public CrearCuentaView(ServicioBancario servicioBancario) {
        CrearCuentaController crearCuentaController = new CrearCuentaController(servicioBancario);
        ...
        crearBtn.addActionListener(e -> {
            try {
                ...
                crearCuentaController.crearCuenta(tipo, saldo, dni, nombre);
    ...
    private void actualizarOtrasVistas(Component componenteActual) {
        ...
        if (parent instanceof JTabbedPane tabbedPane) {
            for (int i = 0; i < tabbedPane.getTabCount(); i++) {
                ...
                if (tab instanceof RealizarTransferenciaView view) view.actualizarCombos();
                if (tab instanceof MovimientosView view) view.actualizarCombos();
            }
        }
    }
}
